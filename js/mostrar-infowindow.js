    ...
    'showFeatureInfo': async function (latlng, info) {
        ...
        switch (queLayer[0]) {
            ...
            case "vw_parcelas": { //se usa este
                ...
                datos1 += '<tr>';
                datos1 += '<td class="linea-rb">Mzd</td><td class="linea-rb">Mzh</td><td class="linea-rb">Letra</td><td class="linea-rb">Lote</td><td class="linea-rb"">Lote Al</td>';
                datos1 += '</tr>';
                datos1 += '<tr>';
                ...
                datos1 += '<span id="parcel_puerta"> ' + datos.features[0].properties['puerta'] + '</span>';
                ...
                if(datos.features[0].properties['adrema'] == 'PH'){
                    ...
                    let tabla1 = '<TABLE class="mr-3" border="1" style="width: 250px;"><THEAD><TR><TH>ADREMAS</TH><TH>PISO</TH><TH>DPTO</TH></TR></THEAD><TBODY id="tbody">';
                    let fila;
...
async function phToAdrema(gid) {
    const res = await fetch('phToAdrema.php?gid=' + gid);
