...
<ul>
    <li id="arbolCapasMcc" data-jstree='{"opened": true, "icon": false}'>
        ...
        <ul>
            ...
            <li id="obrasMunicipales" data-jstree='{"icon": "images/icon/folder-1-16.png", "category": "Obras", "class": "folder"}'>Obras Provincia - Municipio
                <ul>
                    <!-- <li id="reparacion_cordones" data-jstree='{"icon": "images/rep-cordones-reference.svg", "category":"Obras Puntuales"}'>Reparación de cordones</li> -->
                    <li id="instalacion_leds" data-jstree='{"icon": "images/leds-reference.svg", "category":"Obras Puntuales", "opened":true}'>Instalacion de leds </li>
                    <li id="rehabilitacion_sumideros" data-jstree='{"icon": "images/sumideros-reference.svg", "category":"Obras Puntuales"}'>Rehabilitacion de sumideros</li>
                    <li id="intervencion_plazas" data-jstree='{"icon": "images/vialidad1805/interv_plaza.png", "category":"Obras Puntuales"}'>Intervención en plazas</li>
                    <li id="bacheo" data-jstree='{"icon": "images/vialidad1805/bacheo.png", "category":"Bacheo", "opened":true}'> Bacheo </li>
                    <li id="instalacion_camaras" data-jstree='{"icon": "images/vialidad1805/camaras.png"}'>Instalacion de camaras</li>
                    <!--li id="vivienda_lote_propio" data-jstree='{"icon": "images/vialidad1805/viviendas.png"}'>Vivienda lote propio</li-->
                    <li id="espacios_recuperados" data-jstree='{"icon": "images/vialidad1805/gps (2).png"}'>Espacios recuperados</li>
                    <li id="infra_servicios" data-jstree='{"icon": "images/vialidad1805/gps.png"}'>Infra. De Servicios</li>
                    <li id="infra_telec" data-jstree='{"icon": "images/vialidad1805/marker.png"}'>Infra. De Telecomunicaciones</li>
                    <li id="infra_transporte" data-jstree='{"icon": "images/vialidad1805/marker-green.png"}'>Infra. De Transporte</li>
                    <li id="infra_seguridad" data-jstree='{"icon": "images/vialidad1805/infra_seguridad.png"}'>Infra. De Seguridad</li>
                    <li id="infra_educ" data-jstree='{"icon": "images/vialidad1805/infra_educ.png"}'>Infra. Educativa</li>
                    <li id="infra_salud" data-jstree='{"icon": "images/vialidad1805/infra_salud.png"}'>Infra. De Salud</li>
                    <li id="infra_electrica" data-jstree='{"icon": "images/vialidad1805/lighting.png"}'>Infra. Electrica</li>
                    <li id="infra_religiosa" data-jstree='{"icon": "images/vialidad1805/eclipse.png"}'>Infra. Religiosa</li>
                    <li id="mejoras_edif" data-jstree='{"icon": "images/vialidad1805/edificio.png"}'>Mejoras. Edif Publicos</li>
                    <li id="obras_hidricas" data-jstree='{"icon": "images/vialidad1805/obras_hidricas.png"}'>Obras Hidricas</li>
                    <li id="obras_complement" data-jstree='{"icon": "images/vialidad1805/rec.png"}'>Obras Complementarias</li>
                    <li id="obras_hogares" data-jstree='{"icon": "images/vialidad1805/rec(1).png"}'>Obras En Hogares De Niños Y Ancian</li>
                    <li id="obras_nuevo_edif" data-jstree='{"icon": "images/vialidad1805/rec(3).png"}'>Obras Nuevo Edif. Publico</li>
                    <li id="obras_viales" data-jstree='{"icon": "images/vialidad1805/hexagon.svg"}'>Obras Viales</li>
                    <li id="obras_viales_comp" data-jstree='{"icon": "images/vialidad1805/hexagon(1).svg"}'>Obras Viales Complement.</li>
                    <li id="obras_cult_dep_tur" data-jstree='{"icon": "images/vialidad1805/hexagon(2).svg"}'>Cultura, Deporte Y Turismo.</li>
                    <li id="puestas_valor_parques" data-jstree='{"icon": "images/vialidad1805/hexagon(3).svg"}'>Puestas En Val. Parques Y Plazas</li>
                    <li id="cloacas_social" data-jstree='{"icon": "images/cloaca-social-reference.svg", "category":"Obras Lineales"}'> Cloacas social </li>
                    <li id="cordon_cuneta" data-jstree='{"icon": "images/cordon-cuneta-reference.svg", "category":"Obras Lineales"}'> Cordon cuneta </li>
                    <li id="obras_enripiado" data-jstree='{"icon": "images/enripiado-reference.svg", "category":"Obras Lineales"}'> Obras de enripiado </li>
                    <li id="pavimento" data-jstree='{"icon": "images/pavimento-reference.svg", "category":"Obras Lineales"}'> Pavimento</li>
                    <li id="recapado" data-jstree='{"icon": "images/recapado-reference.svg", "category":"Obras Lineales"}'> Recapado </li>
                    <li id="rehabilitacion_pluviales" data-jstree='{"icon": "images/pluviales-reference.svg", "category":"Obras Lineales"}'> Rehabilitación de pluviales </li>
                    <li id="tubos_acceso_dom" data-jstree='{"icon": "images/tubos-reference.svg", "category":"Obras Lineales"}'> Tubos de acceso domiciliario </li>
                    <li id="tubos_cruce_calle" data-jstree='{"icon": "images/tubos-reference.svg", "category":"Obras Lineales"}'> Tubos cruce de calle </li>
                    <li id="veredas" data-jstree='{"icon": "images/veredas-reference.svg", "category":"Obras Lineales"}'> Veredas </li>
                    <li id="limpieza_de_canales" data-jstree='{"icon": "images/limpieza-canales.svg", "category":"Obras Lineales"}'> Limpieza de canales a cielo abierto </li>
                    <!--li id="desarrollo_habitacional" data-jstree='{"icon": "images/polygon.svg"}'> Desarrollo habitacional </li-->
                </ul>
            </li>
